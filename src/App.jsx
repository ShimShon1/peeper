...
export default function App() {
  ...
  async function likePeep(peep) {
    try {
      ...
      await updateDoc(peepRef, {
        likedBy: !peep.likedBy.some((like) => like === user.uid)
          ? [...peep.likedBy, user.uid]
          : peep.likedBy.filter((like) => user.uid !== like),
      });
    } catch (e) {
      console.error(e);
    }
  ...
  return (
    ...
    " */}
        ...
        <main
          className="App   m-auto relative mb-[68px] z-1 col-start-2 col-span-3 w-full border-l border-r
